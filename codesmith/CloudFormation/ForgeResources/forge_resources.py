...
SERVICE_TOKENS = {
    ...
    'Forge::CertificateManager::IssuedCertificateWaitCondition': 'ForgeResources-IssuedCertificateWaitCondition',
    'Forge::Route53::CertificateRecordSetGroup': 'ForgeResources-CertificateRecordSetGroup',
